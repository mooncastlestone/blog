...
description: HTTP와 HTTPS의 가장 큰 차이점은 보안 소켓 계층의 유무이다. 보안 소켓 계층에 대해서 정리하기 전에 우선 HTTP가 어떤 것인지부터 정리를 해보자.
category: Web
thumbnailUrl: https://fastly.picsum.photos/id/282/740/400.jpg?grayscale&hmac=Fxr-F28VZUmL90DSI5krm9DLaKduUr9GeIQNC6IlSok
createdAt: 2021-07-25
published: true
---

![thumbnail](https://fastly.picsum.photos/id/282/740/400.jpg?grayscale&hmac=Fxr-F28VZUmL90DSI5krm9DLaKduUr9GeIQNC6IlSok)
...
정리하자면, HTTPS는 기존 HTTP 프로토콜에 SSL을 적용하여 **서버와 클라이언트 사이의 모든 통신 내용을 암호화할 수 있는 프로토콜이라고
생각하면 될 것 같다.** 그렇다면 이 HTTPS의 장점은 어떤 것들이 있을까?
...
<a
  href="https://blog.wishket.com/http-vs-https-%EC%B0%A8%EC%9D%B4-%EC%95%8C%EB%A9%B4-%EC%82%AC%EC%9D%B4%ED%8A%B8%EC%9D%98-%EB%A0%88%EB%B2%A8%EC%9D%B4-%EB%B3%B4%EC%9D%B8%EB%8B%A4/"
  target="_blank"
>
  http vs https 차이를 알면 사이트의 레벨이 보인다
</a>
<a href="https://eun-jeong.tistory.com/27" target="_blank">
  [네트워크] HTTPS (개념, SSL/TLS 암호화 과정, 장단점)
</a>
<a href="https://github.com/JaeYeopHan/Interview_Question_for_Beginner/tree/master/Network" target="_blank">
